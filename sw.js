const CACHE = 'dr-estomato-v30';
const APP_SHELL = ['/', '/index.html', '/styles.css?v=20260917-5', '/app.js?v=20260917-5', '/manifest.webmanifest', '/assets/dr-estomato.jpeg', '/assets/dr-estomato-profissional.png', '/assets/icon-192.png', '/assets/icon-512.png'];
